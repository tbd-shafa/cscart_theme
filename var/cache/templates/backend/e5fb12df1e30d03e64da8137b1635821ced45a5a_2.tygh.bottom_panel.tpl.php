...
/* Smarty version 4.3.0, created on 2024-11-11 04:08:21
  from '/opt/lampp/htdocs/cs-cart/design/backend/templates/components/bottom_panel/bottom_panel.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_6731f3b56a7344_61077449',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e5fb12df1e30d03e64da8137b1635821ced45a5a' => 
    array (
      0 => '/opt/lampp/htdocs/cs-cart/design/backend/templates/components/bottom_panel/bottom_panel.tpl',
      1 => 1728377995,
      2 => 'tygh',
    ),
  ),
...
function content_6731f3b56a7344_61077449 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/opt/lampp/htdocs/cs-cart/app/functions/smarty_plugins/block.hook.php','function'=>'smarty_block_hook',),1=>array('file'=>'/opt/lampp/htdocs/cs-cart/app/functions/smarty_plugins/modifier.enum.php','function'=>'smarty_modifier_enum',),2=>array('file'=>'/opt/lampp/htdocs/cs-cart/app/functions/smarty_plugins/modifier.trim.php','function'=>'smarty_modifier_trim',),3=>array('file'=>'/opt/lampp/htdocs/cs-cart/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php','function'=>'smarty_modifier_replace',),4=>array('file'=>'/opt/lampp/htdocs/cs-cart/app/functions/smarty_plugins/function.script.php','function'=>'smarty_function_script',),));
...
echo htmlspecialchars((string) fn_url("bottom_panel.redirect?url=".((string)(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url'])))."&area=".((string)(defined('AREA') ? constant('AREA') : null))."&to_area=C".$_prefixVariable3,$_smarty_tpl->tpl_vars['redirect_area']->value), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars((string) fn_url("customization.disable_mode?type=live_editor&return_url=".$_prefixVariable4), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "theme") {?>
                            href="<?php ob_start();
echo htmlspecialchars((string) urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable5=ob_get_clean();
echo htmlspecialchars((string) fn_url("customization.disable_mode?type=theme_editor&return_url=".$_prefixVariable5), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "build") {?>
                            href="<?php ob_start();
echo htmlspecialchars((string) urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable6=ob_get_clean();
echo htmlspecialchars((string) fn_url("customization.disable_mode?type=block_manager&return_url=".$_prefixVariable6), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } else { ?>
...
echo htmlspecialchars((string) fn_url("customization.update_mode?type=live_editor&status=enable&return_url=".$_prefixVariable7), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars((string) fn_url("customization.update_mode?type=theme_editor&status=enable&return_url=".$_prefixVariable8), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
...
echo htmlspecialchars((string) fn_url("customization.update_mode?type=block_manager&status=enable&return_url=".$_prefixVariable9), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
                            id="settings_block_manager"
