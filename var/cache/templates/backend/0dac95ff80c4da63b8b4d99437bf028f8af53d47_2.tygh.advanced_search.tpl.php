...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_6731fd47cdc1b6_83901137',
...
function content_6731fd47cdc1b6_83901137 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_assignInScope('icon_chevron_down', "icon-chevron-down cm-combination cm-save-state".$_prefixVariable17." flex-inline");?>
            <?php ob_start();
if (!$_COOKIE[$_smarty_tpl->tpl_vars['a_id']->value]) {
echo " hidden";
}
$_prefixVariable18=ob_get_clean();
$_smarty_tpl->_assignInScope('icon_chevron_up', "icon-chevron-up cm-combination cm-save-state".$_prefixVariable18." flex-inline");?>
