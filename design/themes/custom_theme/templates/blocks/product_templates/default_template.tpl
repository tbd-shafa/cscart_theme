                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        ...
                        <div class="product__details__pic__slider owl-carousel">
                            {foreach from=$product.image_pairs item=image}
                                <img data-imgbigurl="{$image.detailed.image_path}"
                                ...
                                {if $product}
                                    ...
                                    <div class="">
                                        ...
                                        {hook name="products:main_info_title"}
                                            {if !$hide_title}
                                                <h3 class="" {live_edit name="product:product:{$product.product_id}"}><bdi>{$product.product nofilter}</bdi></h3>
                                            {/if}
                                    ...
                                    {hook name="products:promo_text"}
                                            {if $product.promo_text}
                                             <li><b>Shipping</b> <span>{$product.promo_text nofilter}</span></li>
