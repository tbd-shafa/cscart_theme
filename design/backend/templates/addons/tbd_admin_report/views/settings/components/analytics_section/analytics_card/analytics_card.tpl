    ...
    *}
    ...
    <div class="analytics-card"
        ...
        <div class="analytics-card__inner">
            ...
            {/if}
            {include file="addons/tbd_admin_report/views/settings/components/analytics_section/analytics_card/graph.tpl"
                graph=$analytics_card.graph
            }
             {include file="addons/tbd_admin_report/views/settings/components/analytics_section/analytics_card/pie_chart.tpl"
